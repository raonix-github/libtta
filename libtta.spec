...
Version: 1.0.0
Release: 1%{?dist}
Summary: A TTA library
Group: Applications/System
License: LGPLv2+
URL: http://www.libtta.org/
Source0: https://github.com/downloads/stephane/libtta/libtta-%{version}.tar.gz
BuildRequires: autoconf, automake, libtool, xmlto, asciidoc

%description
libtta is a C library designed to provide a fast and robust implementation of
the TTA protocol. It runs on Linux, Mac OS X, FreeBSD, QNX and Windows.

This package contains the libtta shared library.

%package devel
Summary: Development files for libtta
...
for developing software which uses the libtta library.
...
- add a URL for where to find libtta.
